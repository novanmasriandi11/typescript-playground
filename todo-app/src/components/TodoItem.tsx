...
export function TodoItem({task, completed, onDelete, onToggle}:TodoItemProps) {
    return (
        <div className="flex justify-between items-center p-2 rounded mb-2">
            ...
            <Button onClick={onDelete} className="bg-transparent border">
                 <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-6 h-6" // Ukuran ikon SVG
                >
                    <path
                        strokeLinecap="round"
